...
| `dev-tools` | `0.7.0` | [`jxpeng98/skills`](https://github.com/jxpeng98/skills) | Codex, Claude Code, Antigravity, Hermes | Developer skills for debugging, change review, cross-builds, repository boundaries, release readiness, and App Store releases. |
| `faculty-tools` | `0.7.0` | [`jxpeng98/skills`](https://github.com/jxpeng98/skills) | Codex, Claude Code, Antigravity, Hermes | Daily university faculty skills for teaching, feedback, student communication, meetings, and light academic-service writing. |
| `presentation-tools` | `0.7.0` | [`jxpeng98/skills`](https://github.com/jxpeng98/skills) | Codex, Claude Code, Antigravity, Hermes | Presentation skills for choosing, creating, reviewing, and exporting Slidev, PowerPoint/PPTX, and LaTeX Beamer decks. |
| `productivity` | `0.7.0` | [`jxpeng98/skills`](https://github.com/jxpeng98/skills) | Codex, Claude Code, Antigravity, Hermes | Productivity skills for planning, critique, decisions, commits, and pull requests. |
| `writing-tools` | `0.7.0` | [`jxpeng98/skills`](https://github.com/jxpeng98/skills) | Codex, Claude Code, Antigravity, Hermes | Writing skills for clarity, tone, humanization, general writing polish, academic writing coaching, protected-fact preservation, and summarization. |
