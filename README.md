...
| `qiongli-next` | `1.18.0-beta.3` | [`qiongli` pre-release](https://github.com/jxpeng98/qiongli/releases/tag/v1.18.0-beta.3) | Codex, Claude Code, Claude Desktop | Pre-release Qiongli channel for testing the restructured package layout before it becomes the stable marketplace entry. |
